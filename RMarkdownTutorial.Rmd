...
This is an R Markdown document (`.Rmd`). Markdown is a simple formatting syntax for authoring HTML, PDF, and MS Word documents. For more details on using R Markdown I recommend *Bookdown* <https://bookdown.org/yihui/rmarkdown/markdown-syntax.html>.  
...
## Data
Here, we will import a dummy dataset (mine, lol), 
...
I've hidden the code to write these figures - check out the rmd file to see how to make em.  
...
## Tables
I've hidden the code to write these tables - check out the rmd file to see how to make em.  
