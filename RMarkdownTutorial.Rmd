...
This is an R Markdown document (`.Rmd`). Markdown is a simple formatting syntax for authoring HTML, PDF, and MS Word documents. For more details on using R Markdown I recommend *Bookdown* <https://bookdown.org/yihui/rmarkdown/markdown-syntax.html> [@bookdown2016].  
